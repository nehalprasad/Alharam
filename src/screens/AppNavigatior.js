...
const AppNavigatior = () => {
  ...
  return (
    ...
    <Stack.Navigator>
      ...
      <Stack.Screen name="ProfileUpdate"component={ProfileUpdate}options={{headerShown:false}} initialParams={{ selectedItems, setSelectedItems }}/>
      ...
      <Stack.Screen name="Home"component={Home}options={{headerShown:false}} initialParams={{ email: 'example@email.com', firstname: 'John', lastname: 'Doe' }}/> 
    </Stack.Navigator>
  </NavigationContainer>
  )
}
